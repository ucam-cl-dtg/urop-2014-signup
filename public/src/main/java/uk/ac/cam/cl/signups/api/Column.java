 ...
 * column would correspond to a ticker. Contains a list of slotIDs,
 * each corresponding to a slot stored in mongo.
...
public class Column implements Comparable<Column>{
    ...
    @Override
    public int compareTo(Column other) { // sort by name
